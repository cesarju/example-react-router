...
function GroomingSercives() {
  return (
    <div>
      ...
      <p>
        Anestesiología: Proporciona sedación y analgesia a los pacientes durante
        cirugías y procedimientos.
      </p>
      <ul>
        <li>
          Corte de pelo: Los estilistas de la peluquería pueden cortar el pelo
          del perro en diferentes estilos y longitudes según la preferencia del
          dueño.
        </li>
        <li>
        ...
        <li>
          Corte de uñas: Los profesionales pueden cortar las uñas de los perros
          para prevenir lesiones y problemas de salud.
        </li>
        <li>
        ...
        <li>
          ...
          ofrecen tratamientos especiales para mejorar la salud y la apariencia
          del pelaje y la piel de los perros, como hidratación profunda,
          desenredado y eliminación de pulgas y garrapatas.
        </li>
      </ul>
    </div>
  );
